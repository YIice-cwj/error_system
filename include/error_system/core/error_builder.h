...
namespace error_system::core {
    ...
    class error_builder_t {
        ...
        static constexpr error_code_t make_error_code(error_level_t level,
            ...
            return make_error_code(level, system, static_cast<uint16_t>(subsys), static_cast<uint16_t>(module), number);
        }
        ...
        static constexpr error_code_t make_error_code(error_level_t level,
                                                      ...
                                                      uint16_t module,
                                                      uint16_t number) noexcept {
            constexpr code_t sign_val = 0;
            constexpr code_t reserved_val = 0;

            return error_code_t((sign_val << 63) | (reserved_val << 60) | (static_cast<code_t>(level) << 56) |
                                (static_cast<code_t>(system) << 48) | (static_cast<code_t>(subsys) << 32) |
                                (static_cast<code_t>(module) << 16) | (static_cast<code_t>(number) << 0));
        }
