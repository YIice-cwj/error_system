...
namespace error_system::core {
    ...
    TEST_F(error_builder_test, error_code_constructor_with_uint16) {
    ...
    TEST_F(error_builder_test, from_raw_restores_code) {
    ...
    TEST_F(error_builder_test, error_code_has_sign_zero) {
